...
|------------|------|-------------------|-------------------|--------|
| `planner.md` | Prompt | `apps/backend/prompts/planner.md` | `_extracted/prompts/planner.md` | ✅ Extraído |
| `coder.md` | Prompt | `apps/backend/prompts/coder.md` | `_extracted/prompts/coder.md` | ✅ Extraído |
| `followup_planner.md` | Prompt | `apps/backend/prompts/followup_planner.md` | `_extracted/prompts/followup_planner.md` | ✅ Extraído |
| `qa_reviewer.md` | Prompt | `apps/backend/prompts/qa_reviewer.md` | `_extracted/prompts/qa_reviewer.md` | ✅ Extraído |
